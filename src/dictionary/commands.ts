...
export const COMMANDS: CommandDictionary = Object.freeze(
{
	...
	"M569.6": {
		...
		"parameters": [
			...
			{
				"letter": "V",
				"description": "Tuning manoeuvre to run: 1 basic calibration (not for absolute/magnetic encoders), 2 magnetic encoder calibration, 3 check the stored calibration, 4 clear the stored calibration. Omitted: report the previous manoeuvre's result instead of starting a new one",
				"kind": "unsigned",
				"list": false,
				"expressionAllowed": true,
				"sources": [
					"Duet3Expansion 3.7.0-rc.1 ClosedLoop/ClosedLoop.cpp:469-511 ClosedLoop::ProcessM569Point6 parser.GetUintParam('V', desiredTuning); switch (desiredTuning) case 1/2/3/4 - a further, undocumented case 64 also exists in source (falls through to the same start-tuning path) but is not covered by this description, having no comment or wiki mention explaining its purpose"
				]
			}
		],
		"reviewed": "3.7.0-rc.1",
