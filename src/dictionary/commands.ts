	...
	"M586.4": {
		...
		"parameters": [
			...
			},
			{
				...
				"expressionAllowed": true,
				"sources": [
					"RRF 3.7.0-rc.1 Networking/MQTT/MqttClient.cpp:417-423 MqttClient::Configure gb.MustSee('T') ... setMemb(mqttClientConfig.willTopic)"
				]
			},
			{
				"letter": "Q",
	...
	"M589": {
		...
		"parameters": [
			...
			},
			{
				...
				"expressionAllowed": true,
				"sources": [
					"RRF 3.7.0-rc.1 Networking/ESP8266WiFi/WiFiInterface.cpp:1765-1774 WiFiInterface::HandleWiFiCode gb.MustSee('P'); \"WiFi password must be at least 8 characters\""
				]
			},
			{
				"letter": "I",
				...
				"expressionAllowed": true,
				"sources": [
					"RRF 3.7.0-rc.1 Networking/ESP8266WiFi/WiFiInterface.cpp:1776-1779 WiFiInterface::HandleWiFiCode gb.MustSee('I'); GetIPAddress"
				]
			},
			{
				"letter": "C",
