...
| [12](12-release-model.md) | ✅ Done, full scope — all 504 items (366 RRF commits/21 subsystems + 138 wiki commits) triaged and closed into `src/releases/changes.ts`'s events + `changesBetween`/`impactOf`; several real dictionary gaps found via the wiki cross-check (M106, M308, M569, M575, M584, M593, M906, M950, M558, M574, M116); `rrf-3.7.0-rc.1` tagged and pushed — see Findings | 10, 11 |
